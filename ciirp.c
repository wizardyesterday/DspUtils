...
/* file name: ciirp.c                                                        */
/*                                                                           */
/* The program provides the interface to the parallel realization of the     */
/* iir filter which exists in the file dsputils.c.  Input is taken from the  */
/* standard input with the following interface:                              */
/*                                                                           */
