...
/* file name: clatlad.c                                                      */
/*                                                                           */
/* The program provides the interface to the lattice ladder filter which     */
...
/*  Ladder Parameter:         v index value                                  */
...
float rk[200], rg[200], g[200], x[200], y[200];
...
main()
{
  ...
  { /* compute impulse response y(n) */
    latlad(ip,rk,rg,x[i],&y[i],&oldy,g);
  } /* for */
